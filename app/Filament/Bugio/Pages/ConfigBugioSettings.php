                ...
                Section::make('Configurações de Email')
                    ...
                    ->schema([
                        ...
                        RichEditor::make('email-corpo-cte')
                            ...
                            ->helperText('Placeholders: {placa}, {notas}, {valor_frete_total}, {quantidade_cte}, {valor_frete_unitario}, {motorista_nome}, {motorista_cpf}, {integrado_cpf}, {destinatarios}, {cte_referencia}, {peso_carga}, {data_competencia}, {linha_cte_retroativo}, {linha_cte_complementar}, {linha_alto_desempenho}. Campos sem valor viram N/A automaticamente, exceto os placeholders condicionais, que podem ficar vazios.'),
                    ]),
