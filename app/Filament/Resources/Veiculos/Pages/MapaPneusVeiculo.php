...
class MapaPneusVeiculo extends Page implements HasTable
{
        ...
        return $table
            ...
            ->recordActions([
                Action::make('inspecionar')
                    ...
                    ->visible(fn (PneuPosicaoVeiculo $record) => filled($record->pneu_id))
                    ->url(fn (PneuPosicaoVeiculo $record) => $this->getInspectionUrl($record)),
            ]);
    }
    ...
    public function getViewData(): array
    {
        ...
        return [
            ...
            'selectedInspectionUrl' => $selectedPosicao && filled($selectedPosicao->pneu_id)
                ? $this->getInspectionUrl($selectedPosicao)
                : null,
        ];
    }
    ...
    protected function getInspectionUrl(PneuPosicaoVeiculo $record): string
    {
        return PneuInspecaoResource::getUrl('create', [
            ...
            'redirect' => VeiculoResource::getUrl('mapa-pneus', [
