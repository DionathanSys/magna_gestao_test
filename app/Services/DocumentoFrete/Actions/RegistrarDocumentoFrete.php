...
class RegistrarDocumentoFrete
{
    ...
    private function validate(array $data): void
    {
        ...
        $validate = Validator::make($data, [
            ...
            'documento_transporte.string' => 'O campo Documento de Transporte deve ser um texto válido.',
            'documento_transporte.max' => 'O campo Documento de Transporte deve ter no máximo 50 caracteres.',
