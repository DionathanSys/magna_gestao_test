...
class NfeXmlParser
{
    ...
    public function parse(string $disk, string $path): array
    {
        ...
        return [
            ...
            'emitente_nome' => $this->value($xml, ['//nfe:emit/nfe:xNome', '//emit/xNome']),
            'emitente_documento' => DocumentIdentity::normalizeDigits($this->value($xml, ['//nfe:emit/nfe:CNPJ', '//emit/CNPJ', '//nfe:emit/nfe:CPF', '//emit/CPF'])),
            'destinatario_nome' => $this->value($xml, ['//nfe:dest/nfe:xNome', '//dest/xNome']),
            'destinatario_documento' => DocumentIdentity::normalizeDigits($this->value($xml, ['//nfe:dest/nfe:CNPJ', '//dest/CNPJ', '//nfe:dest/nfe:CPF', '//dest/CPF'])),
            'transportador_nome' => $this->value($xml, ['//nfe:transp/nfe:transporta/nfe:xNome', '//transp/transporta/xNome']),
            'transportador_documento' => DocumentIdentity::normalizeDigits($this->value($xml, ['//nfe:transp/nfe:transporta/nfe:CNPJ', '//transp/transporta/CNPJ', '//nfe:transp/nfe:transporta/nfe:CPF', '//transp/transporta/CPF'])),
