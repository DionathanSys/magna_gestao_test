...
class VincularAgendamento
{
    ...
    public function __construct(protected OrdemServico $ordemServico, protected Models\Agendamento $agendamento)
    {
    ...
    public function validate(): void
    {
        ...
        if ($this->agendamento->servico?->controla_posicao && blank($this->agendamento->posicao)) {
            throw new \InvalidArgumentException('O agendamento precisa ter uma posição definida antes de ser vinculado à Ordem de Serviço.');
        }
    }
}
