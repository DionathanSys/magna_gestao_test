...
return [
    ...
    */
    ...
    'api' => [
        ...
        'timeout_seconds' => (int) env('AUTOMATION_API_TIMEOUT_SECONDS', 15),
    ...
    'webhook' => [
        'issuer_id' => env('AUTOMATION_WEBHOOK_ISSUER_ID', 'automation_prod'),
    ...
    'signature' => [
        'version' => 'v1',
        'encoding' => 'hex',
        'timestamp_tolerance_seconds' => (int) env('AUTOMATION_SIGNATURE_TIMESTAMP_TOLERANCE_SECONDS', 300),
    ...
    'reports' => [
        'daily_trip_summary' => [
            ...
            'collector_version' => env('AUTOMATION_DAILY_TRIP_SUMMARY_COLLECTOR_VERSION', '1.0.0'),
            'schema_version' => env('AUTOMATION_DAILY_TRIP_SUMMARY_SCHEMA_VERSION', '1.0'),
