<x-filament-panels::page>
    ...
    <div>
        <div class="info-box">
            ...
            foi realizado há <strong>mais de 75 dias</strong>.
        ...
        @if(count($dadosRelatorio) > 0)
            <div class="section-box">
                ...
                <div class="section-description">
                    Total de <strong>{{ count($dadosRelatorio) }}</strong> veículo(s) com teste vencido há mais de 75 dias.
        ...
        @elseif($buscaRealizada)
            <div class="section-box">
                <p style="color:#6b7280;font-size:14px;">
                    Nenhum veículo encontrado com teste de fumaça vencido há mais de 75 dias.
                </p>
            </div>
        @endif
    </div>
