<x-filament-panels::page>
    <style>
        ...
        .ag-op-top { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 0.75rem; }
        ...
        .ag-op-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 1rem; }
        ...
        @media (max-width: 1024px) {
            .ag-op-top, .ag-op-grid { grid-template-columns: 1fr 1fr; }
        }
        @media (max-width: 640px) {
            .ag-op-top, .ag-op-grid { grid-template-columns: 1fr; }
        }
    </style>
    ...
    <div class="ag-op-shell">
        <div class="ag-op-top">
            ...
            <div class="ag-op-kpi"><strong>{{ $this->resumo['sem_data'] }}</strong><span>Pendências sem data</span></div>
            <div class="ag-op-kpi"><strong>{{ $this->resumo['checklist'] }}</strong><span>Origem checklist</span></div>
        </div>
