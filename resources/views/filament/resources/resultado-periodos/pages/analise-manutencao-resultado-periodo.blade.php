<x-filament-panels::page>
    <style>
        ...
        .manutencao-os-head { display: flex; justify-content: space-between; gap: 1rem; padding: .85rem 1rem; background: #f8fafc; }
        ...
        <section class="manutencao-card">
            ...
            <div class="manutencao-list">
                @forelse ($manutencoesPorOs as $manutencaoOs)
                    <article class="manutencao-os">
                        <div class="manutencao-os-head">
                            <div>
