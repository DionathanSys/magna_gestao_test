    ...
    <div class="resultado-analise">
        ...
        <section class="resultado-card">
            ...
            <div class="resultado-ops">
                ...
                <div class="resultado-op"><div class="resultado-op-label">Dispersão por abastecimento</div><div class="resultado-op-value">{{ $resumo['dispersao_km_abastecimento'] === null ? 'N/D' : number_format($resumo['dispersao_km_abastecimento'], 0, ',', '.') . ' km' }}</div><div class="resultado-op-detail">KM abastecimento menos KM pago</div></div>
                <div class="resultado-op"><div class="resultado-op-label">Dispersão por KM real</div><div class="resultado-op-value">{{ number_format($resumo['dispersao_km_real'], 0, ',', '.') }} km</div><div class="resultado-op-detail">KM rodado nas viagens menos KM pago</div></div>
