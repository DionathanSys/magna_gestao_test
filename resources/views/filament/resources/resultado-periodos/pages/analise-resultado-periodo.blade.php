    ...
    <div class="resultado-analise">
        ...
        <section class="resultado-card">
            ...
            <div class="resultado-ops">
                ...
                <div class="resultado-op"><div class="resultado-op-label">Faturamento por KM de viagens</div><div class="resultado-op-value">{{ $resumo['faturamento_por_km_rodado'] === null ? 'N/D' : 'R$ ' . number_format($resumo['faturamento_por_km_rodado'], 2, ',', '.') }}</div><div class="resultado-op-detail">Faturamento total por KM registrado nas viagens</div></div>
                <div class="resultado-op"><div class="resultado-op-label">Faturamento por KM pago</div><div class="resultado-op-value">{{ $resumo['faturamento_por_km_pago'] === null ? 'N/D' : 'R$ ' . number_format($resumo['faturamento_por_km_pago'], 2, ',', '.') }}</div><div class="resultado-op-detail">Faturamento total por KM pago</div></div>
